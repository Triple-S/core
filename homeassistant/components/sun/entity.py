...
class Sun(Entity):
    ...
    def update_durations(self, now: datetime | None = None) -> None:
        ...
        utc_point_in_time = dt_util.utcnow()
        try:
            start, end = self.location.daylight(utc_point_in_time, False, self.elevation)
        ...
        try:
            start, end = self.location.night(utc_point_in_time, False, self.elevation)
        ...
        try:
            start, end = self.location.twilight(utc_point_in_time, SunDirection.RISING, False, self.elevation)
        ...
        try:
            start, end = self.location.twilight(utc_point_in_time, SunDirection.SETTING, False, self.elevation)
